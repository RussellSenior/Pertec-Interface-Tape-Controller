...
#ifndef _EBCDIC_DEFINED
#define _EBCDIC_DEFINED 1

unsigned char Ebcdic_Ascii[] =
{
    0x00, 0x01, 0x02, 0x03, 0x9C, 0x09, 0x0a, 0x7F,  // 00 - 07
...
#define E2A(x) (Ebcdic_Ascii[(unsigned char) (x)])  // convert a single character

#endif	// EBCDIC_DEFINED
